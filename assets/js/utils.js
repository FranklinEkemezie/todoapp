const Utils = (function() {
  return class {
    static displayCreateTaskModal() {
      // Form html element
      let add_new_task_section = document.createElement("section");
      add_new_task_section.id = "add-new-task-section";
      add_new_task_section.innerHTML = `
      <form action="/task/create" method="post" id="add-new-task-form">
        <div id="add-new-task-static-backdrop" class="modal fade" data-bs-backdrop="static" data-bs-keyword="false" tabindex="-1">
      ...
      `;
      document.body.appendChild(add_new_task_section);

      // Create-Task modal toggle button
      let btn = document.createElement("button");
      btn.setAttribute("data-bs-toggle", "modal");
      btn.setAttribute("data-bs-target", "#add-new-task-static-backdrop");
